package com.example.savioubuntu.patientgeofenceapplication.model;
...
/**
 * Model class for storing the Geo Fence details.
 * Created by savioubuntu on 4/27/17.
 */
...
public class GeoFenceDetail implements Parcelable {
    ...
    public static final Parcelable.Creator<GeoFenceDetail> CREATOR = new Parcelable.Creator<GeoFenceDetail>() {
        @Override
    ...
    public GeoFenceDetail(String id, String firstName, String lastName,
